(function() {
	...
	ScheduleTemplate.prototype.loadEventContent = function(content) {
        ...
        //     //$('.cd-schedule-modal--content-loaded').load("reserva.html");
        //     $('.cd-schedule-modal-content-loaded').load('http://www.chrome-allow-file-access-from-file.com/windows.html
        // });
    ...
    //             console.log(self.getEventContent(httpRequest.responseText));
